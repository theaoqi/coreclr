...
HRESULT CordbRegisterSet::GetRegistersAvailable(ULONG64* pAvailable)
{
  assert(!"unimplemented on MIPS yet");
    ...
    *pAvailable = SETBITULONG64(REGISTER_MIPS64_PC)
                | SETBITULONG64(REGISTER_MIPS64_SP)
#if 0
                | SETBITULONG64(REGISTER_MIPS64_X0)
                | SETBITULONG64(REGISTER_MIPS64_X1)
                | SETBITULONG64(REGISTER_MIPS64_X2)
                | SETBITULONG64(REGISTER_MIPS64_X3)
                | SETBITULONG64(REGISTER_MIPS64_X4)
                | SETBITULONG64(REGISTER_MIPS64_X5)
                | SETBITULONG64(REGISTER_MIPS64_X6)
                | SETBITULONG64(REGISTER_MIPS64_X7)
                | SETBITULONG64(REGISTER_MIPS64_X8)
                | SETBITULONG64(REGISTER_MIPS64_X9)
                | SETBITULONG64(REGISTER_MIPS64_X10)
                | SETBITULONG64(REGISTER_MIPS64_X11)
                | SETBITULONG64(REGISTER_MIPS64_X12)
                | SETBITULONG64(REGISTER_MIPS64_X13)
                | SETBITULONG64(REGISTER_MIPS64_X14)
                | SETBITULONG64(REGISTER_MIPS64_X15)
                | SETBITULONG64(REGISTER_MIPS64_X16)
                | SETBITULONG64(REGISTER_MIPS64_X17)
                | SETBITULONG64(REGISTER_MIPS64_X18)
                | SETBITULONG64(REGISTER_MIPS64_X19)
                | SETBITULONG64(REGISTER_MIPS64_X20)
                | SETBITULONG64(REGISTER_MIPS64_X21)
                | SETBITULONG64(REGISTER_MIPS64_X22)
                | SETBITULONG64(REGISTER_MIPS64_X23)
                | SETBITULONG64(REGISTER_MIPS64_X24)
                | SETBITULONG64(REGISTER_MIPS64_X25)
                | SETBITULONG64(REGISTER_MIPS64_X26)
                | SETBITULONG64(REGISTER_MIPS64_X27)
                | SETBITULONG64(REGISTER_MIPS64_X28)
#endif
                | SETBITULONG64(REGISTER_MIPS64_FP)
                | SETBITULONG64(REGISTER_MIPS64_RA);
                                       ...
                                       CORDB_REGISTER regBuffer[])
{
  assert(!"unimplemented on MIPS yet");
    ...
    // @MIPS64TODO: floating point support
#if 0
    for (int i = REGISTER_MIPS64_PC;
         i <= REGISTER_MIPS64_LR && iRegister < regCount;
         i++)
    {
        if (mask &  SETBITULONG64(i))
        {
            if ((i >= REGISTER_MIPS64_X0) && (i <= REGISTER_MIPS64_X28))
            {
                regBuffer[iRegister++] = m_rd->X[i - REGISTER_MIPS64_X0];
                continue;
            }

            switch (i)
            {
            case REGISTER_MIPS64_PC:
                regBuffer[iRegister++] = m_rd->PC; break;
            case REGISTER_MIPS64_SP:
                regBuffer[iRegister++] = m_rd->SP; break;
            case REGISTER_MIPS64_FP:
